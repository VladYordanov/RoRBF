...
class PrizesControllerTest < ActionController::TestCase
  ...
  test "should create prize" do
    assert_difference('Prize.count') do
      post :create, prize: { in_stock: @prize.in_stock, is_in_stock: @prize.is_in_stock, name: @prize.name, price: @prize.price }
    end
  ...
  test "should update prize" do
    patch :update, id: @prize, prize: { in_stock: @prize.in_stock, is_in_stock: @prize.is_in_stock, name: @prize.name, price: @prize.price }
    assert_redirected_to prize_path(assigns(:prize))
  end
